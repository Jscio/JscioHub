...
function Kavo.Window(kavName, themeList)
    ...
    function Tabs:Tab(tabName)
        ...
        coroutine.wrap(function()
            ...
            function Elements:Button(bname,tipINf, callback)
                ...
                function ButtonFunction:Update(newTitle)
            ...
            function Elements:TextBox(tname, tTip, callback)
                ...
                function Elements:Toggle(tname, nTip, callback)
                    local TogFunction = {}
                ...
                UpdateSize()
                    ...
                    function TogFunction:Update(newText, isTogOn)
            ...
            function Elements:Slider(slidInf, slidTip, maxvalue, minvalue, callback)
            ...
            function Elements:Dropdown(dropname, dropinf, list, callback)
                ...
                function DropFunction:Update(newList)
                    newList = newList or {}
            ...
            function Elements:ColorPicker(colText, colInf, defcolor, callback)
